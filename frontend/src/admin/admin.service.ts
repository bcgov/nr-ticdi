...
export class AdminService {
  ...
  formatExportData(data: SearchResultsItem[]): ExportDataObject[] {
    ...
    for (let entry of data) {
      ...
      let idir_user_guid = entry.attributes.idir_user_guid[0] ? entry.attributes.idir_user_guid[0] : '';
      let idir_username = entry.attributes.idir_username[0] ? entry.attributes.idir_username[0] : '';
      let display_name = entry.attributes.display_name[0] ? entry.attributes.display_name[0] : '';
