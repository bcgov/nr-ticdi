...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('M',get_provision_group_id(1),'TEMPLATE VARIABLES - NOTICE OF FINAL REVIEW','','Use this to enter values for each of the variables in the boilerplate of the NOTICE OF FINAL REVIEW letter.','DOCUMENT TYPE', true, 1, false);
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('M',get_provision_group_id(2),'FEES','','Use this to create a table listing all the fees to be paid. Table is unprotected, so you will be able to modify text ','FEES', true, 1, false);
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(5),'REPLACEMENT STATEMENT','',' Use this when tenure is being replaced','PREAMBLE', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_default()), (get_current_provision_id(), get_doc_type_delayed()), (get_current_provision_id(), get_doc_type_nofees()), (get_current_provision_id(), get_doc_type_toobtain()), (get_current_provision_id(), get_doc_type_surveyreq());
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(5),'LAND DIFFERS FROM STATEMENT','','Use when land being offered differs from the applied area','OFFER PREAMBLE', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_default()), (get_current_provision_id(), get_doc_type_delayed()), (get_current_provision_id(), get_doc_type_nofees()), (get_current_provision_id(), get_doc_type_toobtain()), (get_current_provision_id(), get_doc_type_surveyreq());
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(5),'FREE FIELD - PREAMBLE INFORMATION','','Use when you want to enter additonal information for the preamble','OFFER PREAMBLE', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_default()), (get_current_provision_id(), get_doc_type_delayed()), (get_current_provision_id(), get_doc_type_nofees()), (get_current_provision_id(), get_doc_type_toobtain()), (get_current_provision_id(), get_doc_type_surveyreq());

INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(15),'OCCUPATIONAL RENT STATEMENT','','Use this where occupational rent is payable','OFFER - MONIES - PAYABLE', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_default()), (get_current_provision_id(), get_doc_type_delayed()), (get_current_provision_id(), get_doc_type_nofees()), (get_current_provision_id(), get_doc_type_toobtain()), (get_current_provision_id(), get_doc_type_surveyreq());
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(20),'DELIVER SECURITY DEPOSIT - NOTICE OF FINAL REVIEW','','Use this to require delivery of security deposit','OFFER - SECURITY', true, 1, false);
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(20),'BLANKET SECURITY STATEMENT','','Use this when client is covered by blanket security agreement','OFFER - SECURITY', true, 1, false);
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(20),'FREE FIELD FOR SECURITY SECTION','','Use where you need to add information regarding security','OFFER - SECURITY', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_default()), (get_current_provision_id(), get_doc_type_delayed()), (get_current_provision_id(), get_doc_type_nofees()), (get_current_provision_id(), get_doc_type_toobtain()), (get_current_provision_id(), get_doc_type_surveyreq());

INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(25),'INSURANCE REQUIRED - NOTICE OF FINAL REVIEW - OTHER','','Use when insurance is required for other tenures eg. homeowners','OFFER - INSURANCE', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_default()), (get_current_provision_id(), get_doc_type_delayed()), (get_current_provision_id(), get_doc_type_nofees()), (get_current_provision_id(), get_doc_type_surveyreq());
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(25),'FREE FIELD FOR INSURANCE','','Use where you want to enter additonal information on insurance','OFFER - INSURANCE', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_default()), (get_current_provision_id(), get_doc_type_delayed()), (get_current_provision_id(), get_doc_type_nofees()), (get_current_provision_id(), get_doc_type_toobtain()), (get_current_provision_id(), get_doc_type_surveyreq());

INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(27),'FREE FIELD - ADDITIONAL REQUIREMENTS','','Use where you want to state additional conditions of the offer','ADDITIONAL REQUIREMENTS', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_default()), (get_current_provision_id(), get_doc_type_delayed()), (get_current_provision_id(), get_doc_type_nofees()), (get_current_provision_id(), get_doc_type_toobtain()), (get_current_provision_id(), get_doc_type_surveyreq());

INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(27),'FREE FIELD - ADDITIONAL REQUIREMENTS - 2','','Use where you want to state additional conditions of the offer','ADDITIONAL REQUIREMENTS', true, 1, false);
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(27),'ADDITIONAL REQUIREMENTS - MANAGEMENT PLAN','','Use to require delivery of a management plan.','ADDITIONAL REQUIREMENTS', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_default()), (get_current_provision_id(), get_doc_type_delayed()), (get_current_provision_id(), get_doc_type_nofees()), (get_current_provision_id(), get_doc_type_toobtain()), (get_current_provision_id(), get_doc_type_surveyreq());
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(27),'ADDITIONAL REQUIREMENTS - OBTAIN AND DELIVER','','Use when you require immediate delivery of documentation.','ADDITIONAL REQUIREMENTS', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_default()), (get_current_provision_id(), get_doc_type_delayed()), (get_current_provision_id(), get_doc_type_nofees()), (get_current_provision_id(), get_doc_type_toobtain()), (get_current_provision_id(), get_doc_type_surveyreq());
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('M',get_provision_group_id(1),'TEMPLATE VARIABLES - NOTICE OF FINAL REVIEW - NO FEES','','require message from POLICY','DOCUMENT TYPE', true, 1, false);
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('M',get_provision_group_id(1),'TEMPLATE VARIABLES - NOTICE OF FINAL REVIEW - DELAYED','','require message from POLICY','DOCUMENT TYPE', true, 1, false);
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(10),'SURVEY CONFIRMATION - CLIENT PAYS - DELAYED','','Use when the client pays for survey.','OFFER SURVEY', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_delayed());
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(10),'SURVEY DEPOSIT - DELAYED','','Use to require payment of a deposit where Province is to pay for a survey.','OFFER SURVEY', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_delayed());
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(10),'PREPARE BOUNDARY PLAN (CLIENT PAYS)','','require message from POLICY','OFFER SURVEY', true, 1, false);
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('M',get_provision_group_id(12),'MONIES PAYABLE - NOTICE OF FINAL REVIEW - DELAYED','','Use when you are providing a firm amount payable.','OFFER SURVEY', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_delayed());

INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('M',get_provision_group_id(12),'ESTIMATED MONIES PAYABLE - NOTICE OF FINAL REVIEW - DELAYED','','Use when you are providing an estimated amount payable.','OFFER SURVEY', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_delayed());
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('M',get_provision_group_id(1),'TEMPLATE VARIABLES - NOTICE OF FINAL REVIEW - TO OBTAIN SURVEY','','require message from POLICY','DOCUMENT TYPE', true, 1, false);
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(10),'BOUNDARY SURVEY (WE PAY)','','Use where we will pay a B.C.L.S. to prepare a boundary survey','OFFER PREAMBLE', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_toobtain());

INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(12),'SURVEY DEPOSIT','','Use to require payment of a deposit where Province is to pay for a survey','OFFER SURVEY', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_toobtain());
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(20),'DELIVER SECURITY DEPOSIT - OS','','require message from POLICY','OFFER - SECURITY', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_toobtain());
INSERT INTO provision_variable (variable_name, variable_value, help_text, "provisionId") VALUES ('INTERIM_TENURE_TYPE','','Insert the type of tenure now being used. e.g. Licence.',get_current_provision_id());
INSERT INTO provision_variable (variable_name, variable_value, help_text, "provisionId") VALUES ('SECURITY_AMOUNT','','#.## to post as security - indicate an amount even if blanket bond applies. Put in Decimal.',get_current_provision_id());

INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(20),'BLANKET SECURITY STATEMENT - OS','','Use this when client is covered by blanket security agreement.','OFFER - SECURITY', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_toobtain());
INSERT INTO provision_variable (variable_name, variable_value, help_text, "provisionId") VALUES ('BLANKET_BOND_NAME','','You are currently covered by a blanket bond between MELP and "____". S...',get_current_provision_id());
INSERT INTO provision_variable (variable_name, variable_value, help_text, "provisionId") VALUES ('INTERIM_TENURE_TYPE','','Insert the type of tenure now being used. e.g. Licence.',get_current_provision_id());

INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(25),'INSURANCE REQUIRED - NOTICE OF FINAL REVIEW - OTHER - OS','','Use when insurance is required for other tenures eg. homeowners','OFFER - INSURANCE', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_toobtain());


-- Document Type 'NOTICE OF FINAL REVIEW (SURVEY REQUIRED)'
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('M',get_provision_group_id(1),'TEMPLATE VARIABLES - NOTICE OF FINAL REVIEW - SURVEY REQUIRED','','require message from POLICY','DOCUMENT TYPE', true, 1, false);
...
INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(10),'SURVEY - MINISTRY PAYS','','Use where ministry pays fro survey','OFFER SURVEY', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_surveyreq());

INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(10),'SURVEY DEPOSIT - DEL','','Use to require payment of a deposit where Province is to pay for a survey.','OFFER SURVEY', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_surveyreq());
INSERT INTO provision_variable (variable_name, variable_value, help_text, "provisionId") VALUES ('DEADLINE_SURVEY_DEPOSIT','','Deadline to pay survey deposit. Enter Month, Day, Year',get_current_provision_id());
INSERT INTO provision_variable (variable_name, variable_value, help_text, "provisionId") VALUES ('DEPOSIT_AMOUNT_SURVEY','','$"#.##" Enter amount of survey deposit.  Put in the decimal.',get_current_provision_id());

INSERT INTO provision (type, "provisionGroupId", provision_name, free_text, help_text, category, active_flag, order_value, is_deleted) VALUES ('V',get_provision_group_id(10),'SURVEY - CLIENT - PAYS','','Use when client pays for survey','OFFER SURVEY', true, 1, false);
INSERT INTO provision_document_type (provision_id, document_type_id) VALUES (get_current_provision_id(), get_doc_type_surveyreq());
INSERT INTO provision_variable (variable_name, variable_value, help_text, "provisionId") VALUES ('DEADLINE_COMPLETE_SURVEY','','on or before "month day, year"',get_current_provision_id());
INSERT INTO provision_variable (variable_name, variable_value, help_text, "provisionId") VALUES ('DEADLINE_CONFIRM_SURVEY','','Enter "On or before [date]" OR "Within [45] days from the date of this letter".  Capitalize first character as this is the start of a sentence.',get_current_provision_id());
