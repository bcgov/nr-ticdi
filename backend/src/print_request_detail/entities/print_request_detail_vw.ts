...
@ViewEntity({
  expression: (dataSource: DataSource) =>
    dataSource
      ...
      .addSelect('print_request_detail.licence_holder_name', 'LicenceHolderName')
      .addSelect('print_request_detail.mailing_address', 'MailingAddress')
      .addSelect('print_request_detail.mailing_city', 'MailingCity')
      .addSelect('print_request_detail.mailing_province_state_code', 'MailingProv')
      ...
      .addSelect('print_request_detail.contact_email_address', 'ContactAgentEmail')
      .addSelect('print_request_detail.contact_phone_number', 'ContactAgentPhone')
      .addSelect('print_request_detail.inspected_date', 'InspectionDate')
      .addSelect('print_request_detail.incorporation_number', 'IncorporationNumber')
