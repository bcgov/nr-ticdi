...
@ViewEntity({
  expression: (dataSource: DataSource) =>
    dataSource
      ...
      .addSelect(
        "nfr_data.db_address_regional_office",
      ...
      .addSelect(
        "nfr_data.var_replacement_tenure_type",
      ...
      .addSelect(
        "nfr_data.var_deadline_completion_requirements",
      ...
      .addSelect(
        "nfr_data.db_fee_payable_amount_gst",
      ...
      .addSelect(
        "nfr_data.var_fee_occupational_rental_amount",
        "VAR_Fee_Occupational_Rental_Amount"
      )
      .addSelect(
        "nfr_data.var_fee_application_amount",
        "VAR_Fee_Application_Amount"
      )
      .addSelect(
        "nfr_data.var_fee_other_credit_amount",
      ...
      .addSelect(
        "nfr_data.db_address_line_regional_office",
      ...
      .addSelect(
        "nfr_data.show_section_twentyfive_1",
        "showSectionTwentyFive_1"
      )
      .addSelect(
        "nfr_data.section_twentyfive_1_text",
        "SectionTwentyFive_1_Text"
      )
      .addSelect(
        "nfr_data.show_section_twentyfive_2",
        "showSectionTwentyFive_2"
      )
      .addSelect(
        "nfr_data.section_twentyfive_2_text",
        "SectionTwentyFive_2_Text"
      )
      .addSelect(
        "nfr_data.show_section_twentyfive_3",
        "showSectionTwentyFive_3"
      )
      .addSelect(
        "nfr_data.section_twentyfive_3_text",
        "SectionTwentyFive_3_Text"
      )
      .addSelect(
        "nfr_data.show_section_twentyfive_4",
        "showSectionTwentyFive_4"
      )
      .addSelect(
        "nfr_data.section_twentyfive_4_text",
        "SectionTwentyFive_4_Text"
      )
      .addSelect(
        "nfr_data.show_section_twentyseven_1",
        "showSectionTwentySeven_1"
      )
      .addSelect(
        "nfr_data.section_twentyseven_1_text",
        "SectionTwentySeven_1_Text"
      )
      .addSelect(
        "nfr_data.show_section_twentyseven_2",
        "showSectionTwentySeven_2"
      )
      .addSelect(
        "nfr_data.section_twentyseven_2_text",
        "SectionTwentySeven_2_Text"
      )
      .addSelect(
        "nfr_data.show_section_twentyseven_3",
        "showSectionTwentySeven_3"
      )
      .addSelect(
        "nfr_data.section_twentyseven_3_text",
        "SectionTwentySeven_3_Text"
      )
      .addSelect(
        "nfr_data.show_section_twentyseven_4",
        "showSectionTwentySeven_4"
      )
      .addSelect(
        "nfr_data.section_twentyseven_4_text",
        "SectionTwentySeven_4_Text"
      )
      .addSelect(
        "nfr_data.show_section_twentyseven_5",
        "showSectionTwentySeven_5"
      )
      .addSelect(
        "nfr_data.section_twentyseven_5_text",
        "SectionTwentySeven_5_Text"
      )
      .addSelect(
        "nfr_data.show_section_twentyseven_6",
        "showSectionTwentySeven_6"
      )
      .addSelect(
        "nfr_data.section_twentyseven_6_text",
